                ...
                <div className="w-1/3 px-10"> {/* Ajustamos el ancho del contenido derecho */} 
                    <div > 
                        ...
                        <li class="ms-4">
                                ...
                                <time class="mb-1 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">Febrero 2023 - junio 2023</time>
                                <h2 class="text-lg font-semibold text-gray-900 dark:text-white">Asador de richard</h2>
                                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Freelancer </h3>
                                <p class="text-base font-normal text-gray-500 dark:text-gray-400">Ecommerce de un restaurante</p>
                            </li>
                            <br/>           
                            <li class="mb-10 ms-4">
                                <div class="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -start-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
