...
const ExperienceCer = ({ experienceCers }) => {
    return (
        <Layout> <div className="flex justify-between"> {/* Flexbox para alinear a la izquierda y derecha */} {/* Contenedor de los certificados */} <div className="w-1/4 px-10"> {/* Ajustamos el ancho del contenido derecho */} <div > <h5 className="mb-2 text-2xl font-bold dark:text-white">Experiencia</h5> </div> <a href="#" className="group relative block h-64 sm:h-80 lg:h-96"> <span className="absolute inset-0 border-2 border-dashed border-black"></span> <div className="relative flex h-full transform items-end  bg-white border border-gray-200 shadow dark:bg-gray-800 dark:border-gray-700 transition-transform group-hover:-translate-x-2 group-hover:-translate-y-2 rounded-lg"> <div className="p-4 !pt-0 transition-opacity group-hover:absolute group-hover:opacity-0 sm:p-6 lg:p-8"> <svg xmlns="http://www.w3.org/2000/svg" className="size-10 sm:size-12" fill="none" viewBox="0 0 24 24" stroke="currentColor" > <path
